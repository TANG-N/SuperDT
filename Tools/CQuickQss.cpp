...
CQuickQss::CQuickQss(QObject *parent) : QObject(parent)
{

}

QString CQuickQss::setBgQss(QWidget *pWidget, QString strBgImage)
{
    QString strObjectname = (nullptr != pWidget) ? pWidget->objectName() : "QWidget";

    QString strStyle = QString("#%1{border-image:url(%2);}")
            .arg(strObjectname).arg(strBgImage);
...
QString CQuickQss::setTextLabelQss(QLabel *pLabel, QString strColor, QString strFontSize, QString strFont, QString strBgColor)
{
    QString strStyle = QString("QLabel{color:%1;font:%2 %3;background:%4;}")
            .arg(strColor).arg(strFontSize).arg(strFont).arg(strBgColor);
...
QString CQuickQss::setHoverBtnQss(QPushButton *pBtn, QString strNormalImage, QString strHoverImage)
{
    if(strHoverImage.isEmpty()){
        strHoverImage =  strNormalImage;
        strHoverImage.replace("_n.","_c.");
    }

    QStringList list;
    list.append(QString("QPushButton{border-image:url(%1);}")
                .arg(strNormalImage));
    list.append(QString("QPushButton:hover{border-image:url(%1);}")
                .arg(strHoverImage));
    list.append(QString("QPushButton:pressed{border-image:url(%1);}")
                .arg(strNormalImage));
    QString strStyle = list.join("");
...
QString CQuickQss::setHoverCheckBtnQss(QPushButton *pBtn, QString strNormalImage, QString strCheckedImage)
{
    if(strCheckedImage.isEmpty()){
        strCheckedImage = QString(strNormalImage).replace("_n.","_c.");
    }
    ...
    list.append(QString("QPushButton:hover{border-image:url(%1);}")
                .arg(strCheckedImage));
    list.append(QString("QPushButton:checked{border-image:url(%1);}")
                .arg(strCheckedImage));
...
QString CQuickQss::setCheckBtnQss(QPushButton *pBtn, QString strNormalImage, QString strCheckedImage)
{
    if(strCheckedImage.isEmpty()){
        strCheckedImage = QString(strNormalImage).replace("_n.","_c.");
    }
...
QString CQuickQss::setPressBtnQss(QPushButton *pBtn, QString strNormalImage, QString strPressedImage)
{
    if(strPressedImage.isEmpty()){
        strPressedImage =  QString(strNormalImage).replace("_n.","_c.");
    }
...
QString CQuickQss::setPushButtonQss(QPushButton *btn, int radius, int padding,
...
QString CQuickQss::setLineEditQss(QLineEdit *txt, int radius, int borderWidth,
                                  const QString &normalColor,
...
QString CQuickQss::setProgressBarQss(QProgressBar *bar, int barHeight,
...
QString CQuickQss::setSliderQss(QSlider *slider, int sliderHeight,
                                const QString &normalColor,
...
QString CQuickQss::setRadioButtonQss(QRadioButton *rbtn, int indicatorRadius,
                                     const QString &normalColor,
...
QString CQuickQss::setScrollBarQss(QWidget *scroll, int radius, int min, int max,
