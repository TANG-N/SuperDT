...
QT_MOC_LITERAL(1, 10, 18), // "signalVSplitScreen"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 18), // "signalHSplitScreen"
QT_MOC_LITERAL(4, 49, 17) // "signalMergeScreen"

    },
    "StatusBar\0signalVSplitScreen\0\0"
    "signalHSplitScreen\0signalMergeScreen"
};
...
void StatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalVSplitScreen(); break;
        case 1: _t->signalHSplitScreen(); break;
        case 2: _t->signalMergeScreen(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatusBar::signalVSplitScreen)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (StatusBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatusBar::signalHSplitScreen)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (StatusBar::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StatusBar::signalMergeScreen)) {
                *result = 2;
                return;
            }
        }
...
void *StatusBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "TWindowLayoutDefine"))
        return static_cast< TWindowLayoutDefine*>(const_cast< StatusBar*>(this));
...
// SIGNAL 0
void StatusBar::signalVSplitScreen()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void StatusBar::signalHSplitScreen()
{
    QMetaObject::activate(this, &staticMetaObject, 1, Q_NULLPTR);
}

// SIGNAL 2
void StatusBar::signalMergeScreen()
{
